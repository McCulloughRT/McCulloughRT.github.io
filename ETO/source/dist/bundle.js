...
exports.changeViz = changeViz;
exports.updateFilters = updateFilters;
exports.changeValue = changeValue;
function clickMap(feature) {
  return {
    type: 'CLICK_MAP',
    payload: feature
  };
...
function updateFilters(interfaceState) {
  return {
    type: 'UPDATE_FILTERS',
...
var _ReactMap = __webpack_require__(/*! ../containers/ReactMap */ "./src/containers/ReactMap.js");

var _ReactMap2 = _interopRequireDefault(_ReactMap);

var _Interface = __webpack_require__(/*! ../containers/Interface */ "./src/containers/Interface.js");
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // import ReactDOM from 'react-dom';


var TOKEN = 'pk.eyJ1IjoicnlhbnRtIiwiYSI6ImNpaDgycjExZzB0NDR1MWtpbWdkeDhxbmIifQ.AamjhGik8yPxK5V71kzHdw';
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_ReactMap2.default, {
          token: TOKEN
          // longitude= { LONG }
          // latitude= { LAT }
          // zoom= { ZOOM }
...
var Interface = function (_Component) {
  ...
  _createClass(Interface, [{
    ...
    value: function handleChange(event, type) {
      ...
      this.setState(_defineProperty({}, type, parseFloat(val)), function () {
        _this2.changed(val, type);
      });
    }
  }, {
    key: 'presetChange',
    ...
    value: function render() {
      ...
      var solarCoverage = this.props.userInt.get('solarCoverage');
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              null,
              'PV Coverage of Lot Area: ',
              this.state.solarCoverage,
              ' %'
            ),
            _react2.default.createElement('input', { type: 'range', min: '0', max: '100', value: this.state.solarCoverage, step: '5', className: 'form-control-range', id: 'solarCoverage', onChange: function onChange(e) {
                return _this3.handleChange(e, 'solarCoverage');
              } })
          ),
          _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(
              ...
              this.state.solarEfficiency,
              ' Watt/SF'
            ),
            _react2.default.createElement('input', { type: 'range', min: '10', max: '20', value: this.state.solarEfficiency, step: '0.5', className: 'form-control-range', id: 'solarEfficiency', onChange: function onChange(e) {
                return _this3.handleChange(e, 'solarEfficiency');
              } })
          ),
          _react2.default.createElement(
            'div',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              null,
              'Minimum Amount of Rent Burden: ',
              this.state.minRentBurden,
              ' %'
            ),
            _react2.default.createElement('input', { type: 'range', min: '0', max: '100', value: this.state.minRentBurden, step: '5', className: 'form-control-range', id: 'minRentBurden', onChange: function onChange(e) {
                return _this3.handleChange(e, 'minRentBurden');
              } })
          )
        ),
        _react2.default.createElement(
          'div',
          { className: 'container', style: style.legendBox },
          _react2.default.createElement('div', { style: style.legendGradient }),
          _react2.default.createElement(
            'div',
            { className: 'row' },
            _react2.default.createElement(
...
function mapDispatchToProps(dispatch) {
  return (0, _redux.bindActionCreators)({
    changeViz: _index.changeViz,
    changeValue: _index.changeValue
  }, dispatch);
}
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Interface);
...
var _diff = __webpack_require__(/*! ../utilities/diff.js */ "./src/utilities/diff.js");
...
var ReactMap = function (_Component) {
  _inherits(ReactMap, _Component);

  function ReactMap() {
    _classCallCheck(this, ReactMap);

    return _possibleConstructorReturn(this, (ReactMap.__proto__ || Object.getPrototypeOf(ReactMap)).apply(this, arguments));
  }
  ...
  _createClass(ReactMap, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.props.center) mapConfig['center'] = this.props.center;
      if (this.props.zoom) mapConfig['zoom'] = this.props.zoom;
      ...
      this.map.on('load', function () {
        ...
        var style = _this2.map.getStyle();
        console.log(style);
        _this2.props.setStyle(style);
        _this2.props.updateFilters(_this2.props.userInterface.toJS());
        ...
        _this2.map.on('click', function (e) {
          ...
          var currentLayer = _this2.props.userInterface.get('activeLayer');
          var selectedFeature = features.filter(function (f) {
            return f.layer.id === currentLayer;
          });
          console.log(selectedFeature);
          _this2.props.clickMap(selectedFeature[0]);

          // Make a popup from stateful markup:
          if (_this2.props.showPopUp && _this2.props.userInterface.get('popup') != null) {
            new mapboxgl.Popup().setLngLat(e.lngLat).setHTML(_this2.props.userInterface.get('popup')).addTo(_this2.map);
          }
        });
      });
    }
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var before = this.props.mapStyle;
      var after = nextProps.mapStyle;
      var map = this.map;

      if (!_immutable2.default.is(before, after)) {
        var changes = (0, _diff2.default)(before.toJS(), after.toJS());
...
function mapDispatchToProps(dispatch) {
  return (0, _redux.bindActionCreators)({
    clickMap: _index.clickMap,
    setStyle: _index.setStyle,
    updateFilters: _index.updateFilters
  }, dispatch);
}
function mapStateToProps(state) {
  return {
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ReactMap);
...
var buildingData = exports.buildingData = {
  maxAge: 2015,
  minAge: 1900,
  minSqft: 500,
  maxSqft: 100000,
  minUnits: 10,
  maxUnits: 200,
  categoryStops: [['Industrial', '#a6cee3'], ['Parking', '#1f78b4'], ['Institutional Religious', '#b2df8a'], ['Multi Family Residential', '#33a02c'], ['Institutional', '#fb9a99'], ['Commercial Retail', '#e31a1c'], ['Commercial Restaurant', '#e31a1c'], ['Commercial Office', '#e31a1c'], ['Commercial Grocery', '#e31a1c'], ['Commercial Hotel', '#e31a1c'], ['Commercial General', '#e31a1c'], ['Vacant', '#fdbf6f'], ['Single Family Residential', '#ff7f00'], ['Residential', '#cab2d6']],
  lightBlue: '#f7fbff',
  darkBlue: '#084594'
};
...
var _init_state = __webpack_require__(/*! ./init_state */ "./src/init_state.js");
...
_reactDom2.default.render(_react2.default.createElement(
  ...
  { store: (0, _redux.createStore)(_reducers2.default, _init_state2.default) },
...
function hydrate() {
  var usePrevious = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
...
var _reducer_stylesheet = __webpack_require__(/*! ./reducer_stylesheet */ "./src/reducers/reducer_stylesheet.js");

var _reducer_stylesheet2 = _interopRequireDefault(_reducer_stylesheet);

var _reduce_userInt = __webpack_require__(/*! ./reduce_userInt */ "./src/reducers/reduce_userInt.js");

var _reduce_userInt2 = _interopRequireDefault(_reduce_userInt);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var rootReducer = (0, _redux.combineReducers)({
  mapStyle: _reducer_stylesheet2.default,
  userInterface: _reduce_userInt2.default
});
...
/***/ "./src/reducers/reduce_userInt.js":
/*!****************************************!*\
  !*** ./src/reducers/reduce_userInt.js ***!
  \****************************************/
/*! no static exports found */
...
exports.default = UserIntReducer;

var _immutable = __webpack_require__(/*! immutable */ "./node_modules/immutable/dist/immutable.js");

var _immutable2 = _interopRequireDefault(_immutable);

var _popup = __webpack_require__(/*! ../utilities/popup */ "./src/utilities/popup.js");

var _popup2 = _interopRequireDefault(_popup);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function UserIntReducer() {
  var userIntState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  var action = arguments[1];
    ...
    case 'CLICK_MAP':
      {
        ...
        var html = (0, _popup2.default)(action.payload);
...
/***/ "./src/reducers/reducer_stylesheet.js":
/*!********************************************!*\
  !*** ./src/reducers/reducer_stylesheet.js ***!
  \********************************************/
/*! no static exports found */
...
exports.default = StylesheetReducer;

var _immutable = __webpack_require__(/*! immutable */ "./node_modules/immutable/dist/immutable.js");

var _immutable2 = _interopRequireDefault(_immutable);

var _buildingData = __webpack_require__(/*! ../data/buildingData */ "./src/data/buildingData.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function StylesheetReducer() {
  var styleState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  var action = arguments[1];
  ...
  switch (action.type) {
    ...
    case 'CHANGE_VALUE':
      {
        ...
        var LAYER_ID = 'lotsareaburden-v102';
        var layerIdx = styleState.get('layers').findIndex(function (layer) {
        ...
        switch (type) {
          ...
          case 'eui':
            {
              var _newStyle2 = styleState.setIn(['layers', layerIdx, 'filter', 1, 1, 2, 1, 1, 2], parseFloat(val));
              return _newStyle2;
              break;
            }
          case 'minRentBurden':
            {
              var _newStyle3 = styleState.setIn(['layers', layerIdx, 'filter', 2, 2], parseFloat(val));
              return _newStyle3;
              break;
            }
          case 'zones':
            {
              ...
              if (val === null) {
                ...
                zones = val.map(function (e) {
                  return ['==', ['get', 'd'], e];
                });
                zones.unshift('any');
              }

              var _newStyle4 = styleState.setIn(['layers', layerIdx, 'filter', 3], zones);
              return _newStyle4;
              break;
            }
          default:
    ...
    case 'UPDATE_FILTERS':
      {
        ...
        var _LAYER_ID = 'lotsareaburden-v102';
        var _layerIdx = styleState.get('layers').findIndex(function (layer) {
          return layer.get('id') === _LAYER_ID;
        });
        var _action$payload2 = action.payload,
            solarCoverage = _action$payload2.solarCoverage,
            solarEfficiency = _action$payload2.solarEfficiency,
            eui = _action$payload2.eui,
            minRentBurden = _action$payload2.minRentBurden,
    ...
    case 'CHANGE_VIZ':
      {
        var _LAYER_ID2 = 'buildings';
        var minAge = _buildingData.buildingData.minAge,
            maxAge = _buildingData.buildingData.maxAge,
            minUnits = _buildingData.buildingData.minUnits,
            maxUnits = _buildingData.buildingData.maxUnits,
            minSqft = _buildingData.buildingData.minSqft,
            maxSqft = _buildingData.buildingData.maxSqft;
        var categoryStops = _buildingData.buildingData.categoryStops,
            lightBlue = _buildingData.buildingData.lightBlue,
            darkBlue = _buildingData.buildingData.darkBlue;
...
function diffSources(before, after, commands, sourcesRemoved) {
    ...
    for (sourceId in after) {
        ...
        } else if (!(0, _lodash.isEqual)(before[sourceId], after[sourceId])) {
...
function diffLayerPropertyChanges(before, after, commands, layerId, klass, command) {
    ...
    for (prop in before) {
        ...
        if (!(0, _lodash.isEqual)(before[prop], after[prop])) {
...
function diffLayers(before, after, commands) {
    ...
    for (i = 0; i < afterOrder.length; i++) {
        ...
        if (clean[layerId] || (0, _lodash.isEqual)(beforeLayer, afterLayer)) continue;

        // If source, source-layer, or type have changes, then remove the layer
        // and add it back 'from scratch'.
        if (!(0, _lodash.isEqual)(beforeLayer.source, afterLayer.source) || !(0, _lodash.isEqual)(beforeLayer['source-layer'], afterLayer['source-layer']) || !(0, _lodash.isEqual)(beforeLayer.type, afterLayer.type)) {
            commands.push({ command: operations.removeLayer, args: [layerId] });
        ...
        if (!(0, _lodash.isEqual)(beforeLayer.filter, afterLayer.filter)) {
            commands.push({ command: operations.setFilter, args: [layerId, afterLayer.filter] });
        }
        if (!(0, _lodash.isEqual)(beforeLayer.minzoom, afterLayer.minzoom) || !(0, _lodash.isEqual)(beforeLayer.maxzoom, afterLayer.maxzoom)) {
        ...
        for (prop in beforeLayer) {
            ...
            } else if (!(0, _lodash.isEqual)(beforeLayer[prop], afterLayer[prop])) {
...
function diffStyles(before, after) {
    ...
    try {
        ...
        if (!(0, _lodash.isEqual)(before.version, after.version)) {
            return [{ command: operations.setStyle, args: [after] }];
        }
        if (!(0, _lodash.isEqual)(before.center, after.center)) {
            commands.push({ command: operations.setCenter, args: [after.center] });
        }
        if (!(0, _lodash.isEqual)(before.zoom, after.zoom)) {
            commands.push({ command: operations.setZoom, args: [after.zoom] });
        }
        if (!(0, _lodash.isEqual)(before.bearing, after.bearing)) {
            commands.push({ command: operations.setBearing, args: [after.bearing] });
        }
        if (!(0, _lodash.isEqual)(before.pitch, after.pitch)) {
            commands.push({ command: operations.setPitch, args: [after.pitch] });
        }
        if (!(0, _lodash.isEqual)(before.sprite, after.sprite)) {
            commands.push({ command: operations.setSprite, args: [after.sprite] });
        }
        if (!(0, _lodash.isEqual)(before.glyphs, after.glyphs)) {
            commands.push({ command: operations.setGlyphs, args: [after.glyphs] });
        }
        if (!(0, _lodash.isEqual)(before.transition, after.transition)) {
            commands.push({ command: operations.setTransition, args: [after.transition] });
        }
        if (!(0, _lodash.isEqual)(before.light, after.light)) {
