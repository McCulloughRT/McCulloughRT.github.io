      ...
      <div className='container'>
        <div className='row' style={ style.headRow }>
          <div className='col-lg-8 col-lg-offset-2 text-center'>
            ...
            <p style={ style.subHeading }>After accepting a position leading strategy and innovation at Andersen Construction, much of my personal work and focus has moved there! You can see a sample of what we've been working on soon there!</p>
          </div>
        </div>
